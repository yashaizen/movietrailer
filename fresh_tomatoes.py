...
<head>
    ...
    <style type="text/css" media="screen">
        body {
            padding-top: 80px;
	    background-image:url("https://inspirationhut.net/wp-content/uploads/2013/05/12.png");
        }
...
<html lang="en">
  <body>
    <!-- Heading -->
	<h1 style="margin-left:38vw; margin-bottom:5vw; color: Blue">Movie Trailers</h1>
    <!-- Trailer Video Modal -->
